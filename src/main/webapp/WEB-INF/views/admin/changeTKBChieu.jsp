...
<% GiaoVienModel giaoVienModel = new GiaoVienModel();
        ...
        <div class="row mt-3">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <div class="card-title">Sửa Thời Khóa Biểu Buổi Chiều</div>
                <hr>	
       <form action="${pageContext.request.contextPath}/admin/changeTKB?id=<%=idRequestNe %>&action=changeBuoiChieu" method="post"  accept-charset="UTF-8">
...
<select class="form-control" name="tietthu65">
        ...
        <form action="${pageContext.request.contextPath}/admin/changeTKB?id=<%=idRequestNe%>&action=xoaBuoiChieu" method="post">
     <button class="add-catalog"> Xóa Thời Khóa Biểu Buổi Chiều</button>
    </form>
    </div>
                </div>
          </div>
